...
- zIndexOffset (number; optional):
    ...
    IconOptions = TypedDict(
        "IconOptions",
            {
            "iconSize": typing.Union[int, float, numbers.Number],
            "iconAnchor": typing.Union[int, float, numbers.Number],
            "popupAnchor": typing.Union[int, float, numbers.Number],
            "className": str,
            "html": str
        }
    )
    ...
    def __init__(
        ...
        position: typing.Optional[typing.Any] = None,
